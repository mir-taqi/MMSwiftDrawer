...
@objc public protocol MMSwiftDrawerDelegate {
...
open class MMSwiftDrawer: UIViewController, UIGestureRecognizerDelegate {
    ...
    public private(set) lazy var screenEdgePanGesture: UIScreenEdgePanGestureRecognizer = {
        let gesture = UIScreenEdgePanGestureRecognizer(
            target: self,
            action: #selector(MMSwiftDrawer.handlePanGesture(_:))
        )
    ...
    public private(set) lazy var containerViewTapGesture: UITapGestureRecognizer = {
        let gesture = UITapGestureRecognizer(
            target: self,
            action: #selector(MMSwiftDrawer.didtapContainerView(_:))
        )
        gesture.delegate = self
        return gesture
    }()
    
    public weak var delegate: MMSwiftDrawerDelegate?
